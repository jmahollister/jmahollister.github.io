(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.max, 400, 170, 5, 0.5);
        collectable.create(type.kennedi, 600, 140, 1, 1);
        collectable.create(type.db, 50, 450, 1, 1);
        collectable.create(type.grace, 700, 350, 5, 0.4);
