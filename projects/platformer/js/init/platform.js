(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(400, 460, 1, 0.3);
        platform.create(500, 200, 1, 0.3);
        platform.create(0, 550, 1, 0.3);
        platform.create(50, 360, 1, 0.3);
        platform.create(430, 260, 0.5, 0.3);
        platform.create(300, 600, 0.5, 0.3);
